...
#[Route(
    path: '/settings/[general|logo|billing|payments|credits|rate-providers|affiliates|openai|cohere|anthropic|xai|elevenlabs|falai|stabilityai|gcp|azure|clipdrop|aimlapi|onesignal|serper|searchapi|mail|smtp|policies|accounts|public-details|recaptcha|appearance|pwa|storage|cdn:name]?',
